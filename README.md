...
O documentos produzidos e que acompanharão o código fonte da aplicação, terão por objetivo explicar a finalidade do software,  suas funcionalidades, suas dependências, as tecnologias utilizadas e sobretudo sua logica de funcionamento e suas regras de negócio. Toda essa documentação além de permitir a equipe desenvolvedora clareza da solução que se pretende desenvolver, como também para permitir maior celeridade na identificação e correção de falhas e manutenção do sistema.
